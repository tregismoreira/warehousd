...
const NAMED_SCHEMAS: { name: string; schema: z.ZodType; io: "input" | "output" }[] = [
  ...
  { name: "RevisionDocumentResponse", schema: R.RevisionDocumentResponseSchema, io: "output" },
  { name: "FieldChange", schema: R.FieldChangeSchema, io: "output" },
  { name: "RevisionDiffResponse", schema: R.RevisionDiffResponseSchema, io: "output" },
