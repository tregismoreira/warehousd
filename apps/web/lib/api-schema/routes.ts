...
import {
  ...
  RevisionDocumentResponseSchema,
...
export const OPERATIONS: Operation[] = [
  ...
  {
    path: "/v1/collections/{c}/documents/{id}/revisions/{rev}",
    method: "get",
    operationId: "getRevision",
    summary: "One past revision of a document, projected through the caller's current grant.",
    tags: ["history"],
    params: [
      cParam,
      idParam,
      {
        ...
        required: true,
        schema: z.string(),
        description: "Revision id, from listRevisions.",
      },
    ],
    success: [
      { status: 200, schema: RevisionDocumentResponseSchema, description: "The revision." },
    ],
    reasons: [...RESTRICTED, "not_found", "field_denied", "unknown_field"],
  },
  {
    path: "/v1/collections/{c}/documents/{id}/revisions/diff",
    method: "get",
    operationId: "diffRevisions",
    summary: "The fields that moved between two revisions of a document.",
    tags: ["history"],
    params: [
      cParam,
      idParam,
    ...
    success: [
      { status: 200, schema: RevisionDiffResponseSchema, description: "The field changes." },
    ],
